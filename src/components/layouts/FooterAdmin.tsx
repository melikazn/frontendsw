  ...
  return (
    <footer className="bg-[#004B94] text-[#fdc500] w-ful py-[30px] pt-10 pb-6 mt-20">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        {/* grid: Kontakt + Navigering + Om oss */}
        <div className="grid md:grid-cols-3 gap-8 mb-8 text-sm">

          {/* Logo och kontaktinformation */}
          <div>
            <img
              src="/images/logo.png"
              alt="Logo"
          ...
          <div className="flex flex-col md:items-center">
            ...
            <span className="cursor-pointer hover:underline mb-1" onClick={() => navigate("/admin/dashboard")}>
              Dashboard
            </span>
            <span className="cursor-pointer hover:underline mb-1" onClick={() => navigate("/admin/forum")}>
              Forum
            </span>
            <span className="cursor-pointer hover:underline mb-1" onClick={() => navigate("/admin/messages")}>
              Meddelande
            </span>
            <span className="cursor-pointer hover:underline" onClick={() => navigate("/admin-login")}>
              Logga ut
            </span>
          </div>
          ...
          <div className="md:text-right">
            ...
            <p className="text-[#fdc500]/90 text-sm leading-relaxed">
              "Konsten att undervisa är konsten att hjälpa till att upptäcka." - Mark Van Dore
            </p>
          </div>
        </div>
