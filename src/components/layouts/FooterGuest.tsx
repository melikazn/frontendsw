...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#004B94] text-[#fdc500] pt-10 pb-6 mt-20">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8 text-sm">
          ...
          <div className="flex flex-col md:items-center">
            ...
            <span className="cursor-pointer hover:underline mb-1" onClick={() => navigate("/register")}>
              Bli medlem
            </span>
            <span className="cursor-pointer hover:underline mb-1" onClick={() => navigate("/vocabulary")}>
              Ordbok
            </span>
            <span className="cursor-pointer hover:underline" onClick={() => navigate("/kontakt")}>
              Kontakta oss
            </span>
          </div>
